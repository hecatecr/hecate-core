...
# Other shards can require this for enhanced testing capabilities
...
module Hecate::Core::TestUtils::Helpers
  ...
  # Convenience methods for common diagnostic types using builder API
  def error_builder(message : String) : Hecate::Core::DiagnosticBuilder
    Hecate::Core.error(message)
  end

  def warning_builder(message : String) : Hecate::Core::DiagnosticBuilder
    Hecate::Core.warning(message)
  end

  def info_builder(message : String) : Hecate::Core::DiagnosticBuilder
    Hecate::Core.info(message)
  end

  def hint_builder(message : String) : Hecate::Core::DiagnosticBuilder
    Hecate::Core.hint(message)
  end
